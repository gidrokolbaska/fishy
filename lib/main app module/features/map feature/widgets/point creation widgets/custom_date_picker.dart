...
const Size _calendarPortraitDialogSize = Size(330.0, 450.0);
...
class CustomDatePickerDialog extends ConsumerStatefulWidget {
  /// A Material-style date picker dialog.
  CustomDatePickerDialog({
    super.key,
    required DateTime initialDate,
  ...
  final TextStyle? customHeaderStyle;
  ...
  @override
  ConsumerState<CustomDatePickerDialog> createState() =>
      _CustomDatePickerDialogState();
}

class _CustomDatePickerDialogState extends ConsumerState<CustomDatePickerDialog>
  ...
  Widget build(BuildContext context) {
    ...
    final String yearText = localizations.formatYear(_selectedDate.value);
    ...
    final Widget actions = Container(
      ...
      child: OverflowBar(
        spacing: 8,
        children: <Widget>[
          if (ref.read(dateProvider) != null)
            TextButton(
              style: TextButton.styleFrom(
                foregroundColor: colorScheme.error,
              ),
              onPressed: () {
                ref.read(dateProvider.notifier).ref.invalidateSelf();
                Navigator.pop(context);
              },
              child: Text(
          ...
          TextButton(
            onPressed: () {
              ref.read(dateProvider.notifier).state =
                  DateUtils.dateOnly(_selectedDate.value);
    ...
    CustomCalendarDatePicker calendarDatePicker() {
      return CustomCalendarDatePicker(
        ...
        customHeaderTextStyle: widget.customHeaderStyle,
      );
    }
    ...
    final Widget header = _DatePickerHeader(
      ...
      titleText: dateText,
      customTitleStyle: widget.titleStyle,
...
class _DatePickerHeader extends StatelessWidget {
  ...
  const _DatePickerHeader({
    ...
    required this.customTitleStyle,
  ...
  static const double _datePickerHeaderPortraitHeight = 94.0;
  ...
  /// The [TextStyle] that the helper text is displayed with.
  final TextStyle? helperStyle;
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle? helpStyle = orientation == Orientation.landscape
        ? textTheme.headlineSmall?.copyWith(color: onPrimarySurfaceColor)
        : textTheme.headlineMedium?.copyWith(color: onPrimarySurfaceColor);
    final TextStyle? titleStyle = orientation == Orientation.landscape
        ? textTheme.headlineSmall?.copyWith(color: onPrimarySurfaceColor)
        : textTheme.headlineMedium?.copyWith(color: onPrimarySurfaceColor);
    final Text help = Text(
      helpText,
      style: helperStyle ?? helpStyle,
      maxLines: 1,
...
class _InputDateRangePickerDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle? helperStyle = orientation == Orientation.landscape
        ? textTheme.headlineSmall?.apply(color: onPrimarySurfaceColor)
        : textTheme.headlineMedium?.apply(color: onPrimarySurfaceColor);
