...
class CustomCalendarDatePicker extends StatefulWidget {
  ...
  final TextStyle? customHeaderTextStyle;
    ...
    switch (_mode) {
      case DatePickerMode.day:
        return _MonthPicker(
          ...
          customHeaderStyle: widget.customHeaderTextStyle,
        );
...
class _MonthPicker extends StatefulWidget {
  ...
  _MonthPicker({
    ...
    required this.customHeaderStyle,
    this.selectableDayPredicate,
...
class _MonthPickerState extends State<_MonthPicker> {
  ...
  Widget _buildItems(BuildContext context, int index) {
    ...
    return _DayPicker(
      ...
      selectableDayPredicate: widget.selectableDayPredicate,
      customHeaderStyle: widget.customHeaderStyle,
    );
  }
...
class _DayPickerState extends State<_DayPicker> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> dayItems =
        _dayHeaders(widget.customHeaderStyle ?? headerStyle, localizations);
        ...
        Widget dayWidget = Container(
          ...
          child: Center(
            child: Text(
              ...
              style: dayStyle.apply(color: dayColor, fontWeightDelta: 5),
            ),
          ),
        );
