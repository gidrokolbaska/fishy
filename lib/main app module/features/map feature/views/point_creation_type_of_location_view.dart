...
class TypeOfLocationBottomSheetPage extends StatelessWidget {
  TypeOfLocationBottomSheetPage({
    Key? key,
    required this.ref,
  }) : super(key: key);
        ...
        child: Column(
          ...
          children: [
                ...
                TextButton(
                  ...
                  onPressed: () {
                    ref
                        ...
                        .update(choicesKey.currentState!.tags);
            ...
            SafeArea(
              ...
              child: ChoicesView(
                key: choicesKey,
                options: typeOfLocationChoicesProvider,
